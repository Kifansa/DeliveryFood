...
return [
    ...
    'schema_cache' => [
        ...
        'path' => env('LIGHTHOUSE_SCHEMA_CACHE_PATH', storage_path('app/lighthouse-schema.php')),
    ],
    'query_cache' => [
    ...
    'cache' => [
        'enabled' => env('LIGHTHOUSE_SCHEMA_CACHE_ENABLE', true),
        'path' => storage_path('app/lighthouse/schema.php'),
    ],
];
